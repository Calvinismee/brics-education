          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <h2 className="truncate text-gray-900" style={{ fontWeight: 800 }}>Riwayat Mengajar</h2>
                <p className="truncate text-xs text-gray-400">Sesi yang sudah selesai berdasarkan jadwal</p>
              </div>
            </div>
                  ...
                  <article key={item.id} className="p-5">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                      <div className="flex min-w-0 gap-3 sm:gap-4">
                        ...
                        <div className="min-w-0">
                          <h4 className="break-words text-base text-gray-900" style={{ fontWeight: 900 }}>{item.title}</h4>
                          <p className="mt-1 break-words text-sm text-gray-500">{item.course}</p>
                      ...
                      <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap lg:justify-end">
                        ...
                        <button
                          ...
                          className="inline-flex min-h-10 items-center justify-center gap-1.5 rounded-xl border border-red-100 px-4 py-2 text-sm text-red-600 hover:bg-red-50"
